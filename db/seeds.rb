...
first_user = User.create(name: 'Akorda Collins', photo_link: 'https://e0.pxfuel.com/wallpapers/820/800/desktop-wallpaper-cute-black-girls-black-cartoon-characters-thumbnail.jpg', bio: 'Undisputed King of DIY', posts_counter: 0)
second_user = User.create(name: 'Baby kenya', photo_link: 'https://costumesheaven.b-cdn.net/wp-content/uploads/2022/05/Judy_is_awesome.PNG.jpg', bio: 'CEO Henna Hub UK', posts_counter: 0)
third_user = User.create(name: 'Young Gaius', photo_link: 'https://kh.wiki.gallery/images/2/24/Nick_Wilde_KHUX.png', bio: 'Fox con artist from Zootopia', posts_counter: 0)
